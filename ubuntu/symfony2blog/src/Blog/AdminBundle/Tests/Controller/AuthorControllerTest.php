...
class AuthorControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $this->assertGreaterThan(0, $crawler->filter('td:contains("Someone")')
            ->count(), 'The new author is not showing up');
        ...
        $this->assertGreaterThan(0, $crawler->filter('[value="Another one"]')->count()
